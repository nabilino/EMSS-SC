...
// $Header: /cvs/cvs_archive/applications/webtier/shr/src/xhrnet/timeentry/lib/Attic/printtimeentrylib.js,v 1.1.2.20 2010/12/10 04:41:24 juanms Exp $
...
function PrintTimeCard(FrameNm, WindowName)
{
	...
	var html = '<div id="printPane" style="padding:5px"><div id="printPaneBox" align="center" styler="groupbox">';
	...
	printWnd.stylePage();
	printDoc.getElementById("printPaneBox").style.width = "auto";
