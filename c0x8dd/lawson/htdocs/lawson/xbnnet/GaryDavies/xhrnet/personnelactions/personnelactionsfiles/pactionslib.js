...
// $Header: /cvs/cvs_archive/applications/webtier/shr/src/xhrnet/personnelactions/personnelactionsfiles/Attic/pactionslib.js,v 1.1.2.13.4.1 2012/05/02 20:32:15 brentd Exp $
...
function storeData()
{
	if (Rules[_RULESINDEX].WebImmediate == "Y") {
		var pend = self.main.document.getElementById("pendOrNot").checked;
		Rules[_RULESINDEX].WebImmediate = pend ? "N" : "Y";
	}
...
function CheckMsg()
{
	...
	{
		parent.MsgBox(getSeaPhrase("DUPLICATE_ACTION","ESS"));
...
function SendEmail()
{
	...
	{
		pfServiceObj = pfObj.lookUpService("EMSSPAAddrChg");
	}
