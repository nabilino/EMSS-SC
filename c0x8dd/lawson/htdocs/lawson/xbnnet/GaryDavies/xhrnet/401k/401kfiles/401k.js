...
// $Header: /cvs/cvs_archive/applications/webtier/shr/src/xhrnet/401k/401kfiles/Attic/401k.js,v 1.1.2.1 2009/03/05 16:55:59 brentd Exp $
...
function PaintResults()
{
	...
	self.RESULTS.document.getElementById("paneBorder").style.overflow = "hidden";
	self.RESULTS.document.getElementById("paneBody").style.width = self.RESULTS.document.getElementById("paneBodyBorder").clientWidth + "px";
	self.RESULTS.document.getElementById("paneBody").style.overflowX = "auto";
...
function Graphit()
{
	...
	page = '<br/><applet id="savingsApplet" codebase="/lawson/java" archive="jchart.jar" code="lawson.jchart.ChartApplet.class" width="700" height="380" alt="'+getSeaPhrase("PORTFOLIO_VALUE","ESS")+'">'
