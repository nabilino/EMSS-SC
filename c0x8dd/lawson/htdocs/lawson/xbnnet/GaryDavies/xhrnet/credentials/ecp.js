...
// $Header: /cvs/cvs_archive/applications/webtier/shr/src/xhrnet/credentials/ecp.js,v 1.13.2.17 2011/07/01 21:27:02 brentd Exp $
var ECPV;
...
//
	if (ECPV.WorkRestrictorIndicator && NonSpace(ECPV.WorkRestrictorIndicator)>0) {
		...
		strHtml = '<div class="fieldlabelbold" style="text-align:left">'
...
// Summary 
//
	strHtml = '<table border="0" cellspacing="0" cellpadding="0" style="width:100%;height:100%">'
	+ '<tr>'
	...
	+ '</tr>'
	+ '<tr>'
	+ '<td class="plaintablerowheader" style="width:46%">'+getSeaPhrase("NEXT_PHYSICAL","CR")+'</td>'
	...
	|| (ECPV.OverduePhysicalIndicator && NonSpace(ECPV.OverduePhysicalIndicator)>0)) {
		strHtml += '<td class="plaintablecellred" style="width:27%;text-align:right" nowrap>'
	...
	if (fromTask && ECPV.Manager) {
		...
		try {
			...
			if (navigator.appName.indexOf("Microsoft") >= 0) {
				...
				tmpStr += '<td class="plaintablecell" style="text-align:right;width:10px" nowrap>'
			...
			if (navigator.appName.indexOf("Microsoft") >= 0) {			
				...
				tmpStr += '<td class="plaintablecell" style="text-align:right;width:100%" nowrap>'
				+ uiButton(getSeaPhrase("BACK","CR"),"CloseEmployeeProfile();return false");
				+ '</td>'			
			}
		}
...
function RefreshCompProfile(empNbr)
{
	...
	if (typeof(parent.showWaitAlert) == "function")
		parent.showWaitAlert(getSeaPhrase("WAIT","CR"));
	else if (typeof(parent.parent.showWaitAlert) == "function")
		parent.parent.showWaitAlert(getSeaPhrase("WAIT","CR"));
...
function PaintRequiredCompetencies(onsort, sortIndex)
{
	...
	&& ECPV.JobCompFlag == "Y") {
		...
		{
			strHtml += '<tr>'
			+ '<td class="plaintablecelldisplay" style="width:50%;text-align:left" nowrap>'
		...
		if (overdueRecs) {
			strHtml += '<tr>'
			+ '<td class="plaintablecellred" colspan="3" style="padding-top:5px;text-align:right" nowrap>'
			+ '<span class="plaintablecellred">' + getSeaPhrase("OVERDUE","CR")
			+ uiRequiredIcon(getSeaPhrase("OVERDUE","CR"))
			+ '</span></td>'
			+ '</tr>'		
		}
...
{
	if (typeof(parent.showWaitAlert) == "function")
		parent.showWaitAlert(getSeaPhrase("CR_9","CR"));
	else if (typeof(parent.parent.showWaitAlert) == "function")
		parent.parent.showWaitAlert(getSeaPhrase("CR_9","CR"));
	...
	if (NonSpace(ECPV.ReqCompetencies[Index].SeqNbr)==0 || ECPV.ReqCompetencies[Index].SeqNbr <= 0) {
		...
		if (ECPV.ReqCompetencies[Index].Type == "CE") {
			...
			if (ECPV.ReqCompetencies[Index].UpdateFlag == "Y") {
				...
				var tmpStr = '<div class="fieldlabelbold" style="text-align:left">'
...
function FinishCMP_DetailScreen(Index)
{
	...
	else
	{
		...
		+ '<tr><td class="fieldlabelboldlite">'+getSeaPhrase("QUAL_4","ESS")+'</td><td class="fieldlabel" style="text-align:left" nowrap>'+CompObj.Description+'</td></tr>'
		...
		if (emssObjInstance.emssObj.filterSelect)
		{
			...
			+ '<span id="skillsourceDesc" style="text-align:left;width:190px" class="fieldlabel">'+EmpCodes.skill_source_description+'</span>'
			+ '</td></tr>'
		}
		else
		{				
		...
		+ uiButton(getSeaPhrase("CANCEL","CR"),"parent.ClearDetailScreen();return false")
...
function FinishCRT_DetailScreen(Index)
{
	...
	if (!self.jsreturn.NbrRecs)
	{
		if (CertObj.UpdateFlag == "Y") {
			...
			var CertificationDesc = '<div class="fieldlabelbold" style="text-align:left">'
			+ getSeaPhrase("NO_QUAL_RECORDS","CR")
			+ '</div>'
		}
	}
	else
	{
		...
		else
		{
			...
			+ '<input type="hidden" name="code" value="'+EmpCodes.code+'">'
			+ '<table border="0" cellspacing="0" cellpadding="0" width="100%">'
			+ '<tr><td class="fieldlabelboldlite">'+getSeaPhrase("QUAL_4","ESS")+'</td><td class="fieldlabel" style="text-align:left" nowrap>'+CertObj.Description+'</td></tr>'
			...
			if (emssObjInstance.emssObj.filterSelect)
			{
				...
				+ '<img align="top" src="/lawson/xhrnet/ui/images/ico_form_dropmenu.gif" border="0"></a>'
				+ '<span id="stateDesc" style="text-align:left;width:190px" class="fieldlabel"></span>'
				+ '</td></tr>'
			}
			else
			{			
			...
			if (emssObjInstance.emssObj.filterSelect)
			{
				...
				+ '<img align="top" src="/lawson/xhrnet/ui/images/ico_form_dropmenu.gif" border="0"></a>'
				+ '<span id="currencycodeDesc" style="text-align:left;width:190px" class="fieldlabel">'+EmpCodes.currency_description+'</span>'
				+ '</td></tr>'
			}
			else
			{						
			...
			CertificationDesc += '<tr><td>&nbsp;</td><td class="plaintablecell" style="text-align:left">'
			+ uiButton(getSeaPhrase("UPDATE","CR"),"parent.UpdateQualification_OnClick("+Index+",\'C\');return false")
			+ uiButton(getSeaPhrase("CANCEL","CR"),"parent.ClearDetailScreen();return false")
			+ uiButton(getSeaPhrase("DELETE","CR"),"parent.DeleteQualification_OnClick("+Index+");return false","margin-left:15px")
			+ '</td></tr>'
...
function DrawAddDetailContent(Index)
{
	...
	if (QualObj.Type == "CE")
	{
		...
		+ '<table border="0" cellspacing="0" cellpadding="0" width="100%">'
		+ '<tr><td class="fieldlabelboldlite">'+getSeaPhrase("QUAL_4","ESS")+'</td><td class="fieldlabel" style="text-align:left" nowrap>'+QualObj.Description+'</td></tr>'
		+ '<tr><td class="fieldlabelboldlite">'+getSeaPhrase("QUAL_14","ESS")+'</td>'
		...
		if (emssObjInstance.emssObj.filterSelect)
		{
			...
			+ '<a href="javascript:parent.openDmeFieldFilter(\'skillsource\')" style="margin-left:5px">'
			+ '<img align="top" src="/lawson/xhrnet/ui/images/ico_form_dropmenu.gif" border="0"></a>'
			+ '<span id="skillsourceDesc" style="text-align:left;width:190px" class="fieldlabel"></span>'
			+ '</td></tr>'
		}
		else
		{		
		...
		if (emssObjInstance.emssObj.filterSelect)
		{
			...
			+ '<a href="javascript:parent.openDmeFieldFilter(\'currencycode\')" style="margin-left:5px">'
			+ '<img align="top" src="/lawson/xhrnet/ui/images/ico_form_dropmenu.gif" border="0"></a>'
			+ '<span id="currencycodeDesc" style="text-align:left;width:190px" class="fieldlabel"></span>'
			+ '</td></tr>'
		}
		else
		{				
	...
	else
	{
		...
		+ '<input type="hidden" size="20" maxlength="30" name="qualification" value="'+QualObj.Description+'">'
		+ '<table border="0" cellspacing="0" cellpadding="0" width="100%">'
		+ '<tr><td class="fieldlabelboldlite">'+getSeaPhrase("QUAL_4","ESS")+'</td><td class="plaintablecelldisplay" style="text-align:left" nowrap>'+QualObj.Description+'</td></tr>'
	...
	if (QualificationContent != "")
	{
		...
		QualificationContent += '<tr><td>&nbsp;</td><td class="plaintablecell" style="text-align:left">'
...
function UpdateQualification_OnClick(Index, fc)
{
	...
	{
		case "CE": Do_Crt_Call(qualForm, "PA22.1", fc, "form", ECPV.EmployeeCode); break; // Update this certification record.
...
function DeleteQualification_OnClick(Index)
{
	...
	switch (ECPV.ReqCompetencies[Index].Type)
	{
		case "CE": Do_Crt_Call(qualForm, "PA22.1", "D", "form", ECPV.EmployeeCode); break; // Delete this certification record.
