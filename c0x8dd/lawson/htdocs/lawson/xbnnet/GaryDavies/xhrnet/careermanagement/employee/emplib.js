...
// $Header: /cvs/cvs_archive/applications/webtier/shr/src/xhrnet/careermanagement/employee/Attic/emplib.js,v 1.1.2.3 2010/01/11 19:22:34 brentd Exp $
...
function DrawActionPlanWithCloseIcon_MyActionPlan()
{
	...
	var Desc = "<form name=frmAttachmentsForm><span class=contentlabelCM>"+getSeaPhrase("CM_102","CM")+"</span>"
		...
		+ uiButton(getSeaPhrase("CM_94","CM"),"parent.Cancel_MyActionPlan_OnClick();return false;")
...
function RefreshAttachmentWindow_MyActionPlan()
{
	...
	var arg = '<div class="contenttextCM" style="width:100%;height:80%">';
	...
	if (self.jsreturn.CmtRec && self.jsreturn.CmtRec.length) {
		arg += '<div>' 
			...
			+ uiButton(getSeaPhrase("CM_90","CM"),"parent.PrintActionPlan_MyActionPlan_OnClick();return false;")
...
function DrawJobOpeningsWindows()
{
	...
	createLayer("main","JobAlertTab_JobAlertHeader",520,60,300,100,true,Desc,"","");
...
function DME_TO_JOB_CODE_FINISHED()
{
	if (emssObjInstance.emssObj.filterSelect)
	{
		...
		createLayer("main","JobAlertFilterSelect1Desc_JobOpenings",641,150,150,30,isVisible,Desc,"","");
		...
		createLayer("main","JobAlertFilterSelect2Desc_JobOpenings",641,173,150,30,isVisible,Desc,"","");
		...
		createLayer("main","JobAlertFilterSelect3Desc_JobOpenings",641,196,150,30,isVisible,Desc,"","");			
...
function DrawJobTitleTab_EmployeeExploreCareers()
{
	...
	createLayer("main","JobTitle_Instructions",450,140,300,100,true,Desc,"","");
...
function DrawCategoryTab_EmployeeExploreCareers()
{
	...
	createLayer("main","Category_Instructions",450,140,300,100,true,Desc,"","");
...
function DrawQualCriteriaTab_EmployeeExploreCareers()
{
	...
	createLayer("main","QualCriteria_Instructions",450,110,300,200,true,Desc,"","");
