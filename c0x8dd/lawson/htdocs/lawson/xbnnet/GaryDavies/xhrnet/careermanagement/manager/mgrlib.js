...
// $Header: /cvs/cvs_archive/applications/webtier/shr/src/xhrnet/careermanagement/manager/Attic/mgrlib.js,v 1.1.2.5 2011/07/08 17:15:22 brentd Exp $
...
function DrawSelectCriteria_GroupProfile()
{
	...
	Desc = '<form name="pJobForm"><span class="contenttextheaderCM">'+getSeaPhrase("CM_376","CM")+'</span>'
		...
		+ uiButton(getSeaPhrase("CM_379","CM"),"parent.StartOver_MyJobProfile_OnClick();return false;","margin-top:10px")
		+ '</td></tr>'
		+ '</table></form>'
...
function DrawEmployeeActionPlanWithCloseIcon_MyActionPlan()
{
	...
	var Desc = "<form name=frmAttachmentsForm><span class=contentlabelCM>"+getSeaPhrase("CM_102","CM")+"</span>"
		...
		+ "<br><p><br>"
		+ "<textarea class=contenttextCM wrap name=comments cols="+width+" rows=20></textarea>"
		+ "</form>"
		+ '<div>'
		+ uiButton(getSeaPhrase("CM_95","CM"),"parent.Update_EmployeeActionPlan_OnClick();return false;")
		+ uiButton(getSeaPhrase("CM_94","CM"),"parent.Cancel_EmployeeActionPlan_OnClick();return false;")
...
function RefreshAttachment_Manager()
{
	...
	{
		Desc = '<div class="contenttextCM" style="width:100%;height:80%">'
		...
		Desc += '<div>' 
			...
			+ uiButton(getSeaPhrase("CM_90","CM"),"parent.PrintActionPlan_EmployeeActionPlan_OnClick();return false;")
...
function DrawJobTitleTab_ManagerExploreCareers(SelectValues)
{
	...
	createLayer("main","JobTitle_Instructions",450,120,300,125,true,Desc,"","");
...
function DrawCategoryTab_ManagerExploreCareers(SelectValues)
{
	...
	createLayer("main","Category_Instructions",450,140,300,125,true,Desc,"","");
...
function DrawQualCriteriaTab_ManagerExploreCareers(SelectValues)
{
	...
	createLayer("main","QualCriteria_Instructions1",450,105,300,130,true,Desc,"","");
	...
	createLayer("main","QualCriteria_Instructions2",450,200,300,90,true,Desc,"","");	
	
	Desc = '<span class="contentlabelCM">'+getSeaPhrase("CM_4","CM")+'</span>'
	createLayer("main","QualCriteria_DirectReportsLabel",505,150,200,25,true,Desc,"","");
	MakeSelectBox("DirectReports", 505, 170, 300, 25, "cmbDirectReports", SelectValues, true, _DIRECTREPORTSINDEX, true)
	...
	MakeButton(getSeaPhrase("CM_123","CM"), 450, 470, 160, 30, ButtonBorderColor, "qualcriteria_createjoblist_ManagerExploreCareers", true);	
