...
// $Header: /cvs/cvs_archive/applications/webtier/shr/src/xbnnet/bessleload.js,v 1.14.2.25.4.1 2011/11/16 07:30:29 juanms Exp $
...
function getFamilyStatusHistory()
{
	if (LoadError) 
		return
	if (rule_type == "F")
		parent.showWaitAlert(getSeaPhrase("LOOK_UP_EMP_INFO","BEN"))
	else
...
function EligPlan(fc)
{
	...
	if(fc == "+")
		fc = "%2B"
	if (rule_type == "F")
		parent.showWaitAlert(getSeaPhrase("PREPARE_ENROLL","BEN"))
	else
...
function CurrentBenefits(fc)
{
	...
	{
		if (rule_type == "F")
			parent.showWaitAlert(getSeaPhrase("RETRIEVE_CUR_BENS","BEN"))
		else
