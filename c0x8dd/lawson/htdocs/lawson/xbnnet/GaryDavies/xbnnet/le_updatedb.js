...
// $Header: /cvs/cvs_archive/applications/webtier/shr/src/xbnnet/le_updatedb.js,v 1.12.2.11.4.1 2012/04/04 06:43:10 juanms Exp $
		...
		if(typeof(parent.CurrentBens[count])!="undefined")
		{
			...
			if(parent.CurrentBens[count]!=null)
			{
				for(var k=1;k<21;k++)
				{
					...
					{
						if(parent.CurrentBens[count][0][0]!=2 && parent.CurrentBens[count][0][0]!=5)  //only stop plans that are changes or stops
						{
