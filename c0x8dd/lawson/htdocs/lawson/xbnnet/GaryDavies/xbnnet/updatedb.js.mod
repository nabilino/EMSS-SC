...
// JRZ Added return values to this function
//     Clicking Cancel on the alert box that is a result of the confirm(warning) call
//     prevents the ability to click "Keep these benefits?" again.
//     This is because client side logic in bensummary.htm thinks that the benefits have already been saved
...
//		var warning = getSeaPhrase("UPDATEBEN_42","BEN");
		var warning = "If you choose to keep these benefits and you want to make additional changes later,\n"
			+ "you will have to contact the benefits department.\n\nIf you are not sure of the elections you made, "
			+ "we suggest you 'Cancel' and then choose \n'Exit and make elections later'.\n\n"
			+ "You can then use the web enrollment process when you have made your final decisions.\n\n"
			+ "Choose 'OK' to keep these benefits."
// END OF MOD
...
// MOD BY BILAL  -  Button styling
	if(onQuit) 
	{
//		html += uiButton(getSeaPhrase("EXIT","BEN"), "parent.SetChoices();return false","margin-right:0px;margin-top:10px")
		html += uiButton(getSeaPhrase("EXIT","BEN"), "parent.SetChoices();return false", "font-size:14px;font-weight:bold;color:#FFFFFF;width:100;background-color:#6699cc;margin-top:10px;margin-right:0px;margin-left:10px")
	}
	else 
	{
//		html += uiButton(getSeaPhrase("CONTINUE","BEN"), "parent.SetChoices();return false","margin-top:10px")
		html += uiButton(getSeaPhrase("CONTINUE","BEN"), "parent.SetChoices();return false","font-size:14px;font-weight:bold;color:#FFFFFF;width:100;background-color:#6699cc;margin-top:10px")
	}
	html += '</p>'
	html += '</td></tr>'
	html += '</table>'
