...
{		
	...
	if(recType=="01" || parseFloat(recType)==1)
	{
		...
		if(ischanged)
			bod+="* "
		bod+=planDesc+'&nbsp;</td><td class="plaintablecellborderright" nowrap>&nbsp;'+arr[2]+'&nbsp;</td>'
		if(showDate)
	...
	if(recType=="04" || parseFloat(recType)==4)
	{
		...
		if(ischanged)
			bod+="* "
		bod+=planDesc+'&nbsp;</td><td class="plaintablecellborderright" nowrap>&nbsp;'+formatCont(arr[17])+'&nbsp;</td>'
		if(showDate)
			bod+='<td class="plaintablecellborder">&nbsp;'+planDate+'&nbsp;</td>'
		if (!issplit)
			bod+=getCosts(arr,recType,planDesc,isflex,issplit,"P",false)+'</tr>'
...
function GetSummaryTable()
{
	...
	table += '<tr><th scope="col" class="plaintableheaderborder" style="width:50%;text-align:center;white-space:nowrap">'+cost_div_desc+'</th>'
	table += '<th scope="col" class="plaintableheaderborder" style="width:50%;text-align:center;white-space:nowrap">'+getSeaPhrase("COST","BEN")+'</th></tr>'
