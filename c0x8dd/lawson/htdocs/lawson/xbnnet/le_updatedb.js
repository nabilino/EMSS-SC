...
// $Header: /cvs/cvs_archive/applications/webtier/shr/src/xbnnet/le_updatedb.js,v 1.12.2.22 2013/12/09 22:00:38 brentd Exp $
//***************************************************************
//*                                                             *
//*                           NOTICE                            *
//*                                                             *
			...
			if (parent.CurrentBens[count]!=null)
			{
				for (var k=1; k<6; k++)
				{
					if (parent.CurrentBens[count]!=null && parent.CurrentBens[count][0]!=null)
					{
						...
						{
							var payRate = "";
							if ((parseInt(parent.CurrentBens[count][22], 10) == 8 || parseInt(parent.CurrentBens[count][22], 10) == 9) && parent.CurrentBens[count][27])
