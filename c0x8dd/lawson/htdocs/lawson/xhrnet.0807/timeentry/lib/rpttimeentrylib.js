...
// $Header: /cvs/cvs_archive/applications/webtier/shr/src/xhrnet/timeentry/lib/Attic/rpttimeentrylib.js,v 1.1.2.47 2012/06/29 17:24:22 brentd Exp $
//***************************************************************
//*                                                             *
//*                           NOTICE                            *
//*                                                             *
...
function PaintDetailScreen()
{
	...
	html += uiButton(getSeaPhrase("BACK","TE"),"parent.BackToStatuses_ForDetail();return false","margin-left:5px")
	try
	{
		if (opener)
		{
			html += uiButton(getSeaPhrase("QUIT","TE"),"parent.Quit_Clicked();return false","margin-left:5px")
		}
	} catch(e) {}
	html += '</td>'
	html += '</tr></table>'
...
function PaintDetailRecords(onsort, sortField)
{
	...
	html += '</td></tr></table>'	
	html += '<table id="detailReportTbl" border="1" align="center" cellspacing="0" cellpadding="0" style="width:100%;text-align:center;margin-left:auto;margin-right:auto" styler="list">'
	html += '<tr>'
...
{
	if (seaConfirm(getSeaPhrase("OK_TO_SUMMARIZE_REPORT","TE"), "", FireFoxPrintDetailReport))
	{
		Print_Clicked_Detail_Report();
	}	
}

function FireFoxPrintDetailReport(confirmWin)
{
...
function Print_Clicked_Detail_Report()
{
	...
	var html = '<div style="text-align:center">'
	html += '<table border="0" width="100%" cellspacing="0" cellpadding="0" style="width:100%;text-align:center;margin-left:auto;margin-right:auto" styler="list">'
	html += '<tr><td class="plaintablecellbold" align=center>'+getSeaPhrase("TE_REPORT_DETAIL","TE")+'</td></tr>'
	html += '</table>'
	html += '<table border="1" align="center" cellspacing="0" cellpadding="0" style="width:100%;text-align:center;margin-left:auto;margin-right:auto">'
	html += '<tr>'
	html += '<th style="text-align:center" styler_click="StylerEMSS.onClickColumn" styler_init="StylerEMSS.initListColumn">'
	html += '<a class="columnsort" href="" onclick="parent.SortThisPuppy(\'DATE\');return false;">'+getSeaPhrase("DATE","TE")+'</a>'
	html += '</th>'
...
function PaintMissingTimeCardReport()
{
	...
	html += uiButton(getSeaPhrase("PRINT","TE"),"parent.Print_Clicked();return false","margin-left:5px")
	html += uiButton(getSeaPhrase("BACK","TE"),"parent.BackToReporting();return false","margin-left:5px")
	try
	{
		if (opener)
		{
...
{	
	...
	html += '</p>'
	html += '<table id="missingReportTbl" align="center" border="1" cellspacing="0" cellpadding="0" style="width:100%;text-align:center;margin-left:auto;margin-right:auto" styler="list">'
	html += '<tr>'
	html += '<th style="text-align:center" styler_click="StylerEMSS.onClickColumn" styler_init="StylerEMSS.initListColumn">'
...
function Print_Clicked()
{
	...
	var html = '<table align="center" border="1" cellpadding="0" cellspacing="0" style="width:650px" styler="list">'
...
function PaintSummaryReport(onsort, sortField)
{
	...
	html += uiButton(getSeaPhrase("BACK","TE"),"parent.BackToStatuses();return false","margin-left:5px")
	try
	{
		if (opener)
		{
...
function PaintSummaryReportRecords(onsort, sortField)
{
	...
	html += '</table>'	
	html += '<table id="summaryReportTbl" border="1" align="center" cellspacing="0" cellpadding="0" style="width:100%;text-align:center;margin-left:auto;margin-right:auto" styler="list">'
    	html += '<tr>'
    	html += '<th style="text-align:center" styler_click="StylerEMSS.onClickColumn" styler_init="StylerEMSS.initListColumn">'
