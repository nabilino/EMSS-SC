...
// $Header: /cvs/cvs_archive/applications/webtier/shr/src/xhrnet/timeentry/lib/Attic/mgrtimeentrylib.js,v 1.1.2.17 2012/06/29 17:24:22 brentd Exp $
//***************************************************************
//*                                                             *
//*                           NOTICE                            *
//*                                                             *
...
function PaintHeaders()
{
	...
	html += '<table border="0" cellpadding="0" cellspacing="0" style="width:100%"><tr><td style="text-align:center;width:100%">';
	html += '<table border="0" cellpadding="0" cellspacing="0" style="width:auto;margin-left:auto;margin-right:auto"><tr>'
	html += '<td class="fieldlabelbold">'
	html += getSeaPhrase("PAY_PLAN","TE")+'</td><td class="fieldlabel">'+Reports.PlanCodeDescription
	html += '</td></tr></table></td>'
	
	if (arguments.length == 0)
	{
		html += '<td class="plaintablecellright">'
	...
	html += '</tr></table>'
	html += '<table style="width:auto;margin-left:auto;margin-right:auto" cellspacing="0" cellpadding="0" border="0">'
	...
	html += dteDay(Reports.PeriodStart)+', '+FormatDte3(Reports.PeriodStart)+'</td>'
