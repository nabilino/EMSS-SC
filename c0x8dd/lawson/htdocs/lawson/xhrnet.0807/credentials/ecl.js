...
// $Header: /cvs/cvs_archive/applications/webtier/shr/src/xhrnet/credentials/ecl.js,v 1.13.2.11 2012/06/29 17:24:23 brentd Exp $
//***************************************************************
//*                                                             *
//*                           NOTICE                            *
//*                                                             *
...
function StartExpiredCompetencyReport(check)
{
	...
	htmlStr += '</td>';
	htmlStr += '<td class="plaintablecell" style="width:175px;vertical-align:bottom">';
	htmlStr += '<span style="white-space:nowrap">'+uiRequiredIcon()+getSeaPhrase("REQUIRED","CR")+'</span>';
	htmlStr += '</td>';	
	htmlStr += '</tr>';	
	htmlStr += '</table>';
	htmlStr += '</form>';
	htmlStr += '<div id="expiredCompDtl" style="width:100%;height;auto;overflow:auto">&nbsp;</div>';
