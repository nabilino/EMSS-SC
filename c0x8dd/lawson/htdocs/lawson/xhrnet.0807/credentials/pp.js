...
// $Header: /cvs/cvs_archive/applications/webtier/shr/src/xhrnet/credentials/pp.js,v 1.14.2.18 2012/06/29 17:24:23 brentd Exp $
//***************************************************************
//*                                                             *
//*                           NOTICE                            *
//*                                                             *
...
{
	var strHtml = '<div class="plaintablecellborderdisplay">'+getSeaPhrase("CR_11","CR")+'</div>';
...
function PaintManagerReportSelect()
{
	if (fromTask && PPV.Manager) {
		...
		try {
			...
			if (ppCnt > 1) {
				tmpStr += '<td class="plaintablecellright" style="width:auto" nowrap>'
			...
			tmpStr += '<td class="plaintablecellright" style="width:100%;padding-right:0px;background-color:transparent" nowrap>'
			+ uiButton(getSeaPhrase("BACK","CR"),"CloseProfessionalProfile();return false","margin-right:0px");
			+ '</td>'
		}
...
function PaintPPPVWindowContent()
{
	...
	var strHtml = '<table border="0" cellspacing="0" cellpadding="0" width="100%">'
	+ '<tr>'
	+ '<th class="plaintableheaderbordergrey" id="edu" style="width:63%;" colspan="3">'+getSeaPhrase("EDUCATION","CR")+'</th>'
	+ '<th class="plaintableheaderbordergrey" id="NBME" style="width:37%;">'+getSeaPhrase("CR_19","CR")+'</th>'
	+ '</tr>'
	+ '</table>'
	...
	strHtml += '<table border="0" cellspacing="0" cellpadding="0" width="100%">'
	+ '<tr>'
	+ '<th class="plaintableheaderbordergrey" id="ACGME" style="width:63%;" colspan="3">'+getSeaPhrase("CR_17","CR")+'</th>'
	+ '<th class="plaintableheaderbordergrey" id="ECFMG" style="width:37%;">'+getSeaPhrase("CR_20","CR")+'</th>'
	+ '</tr>'
	+ '</table>'
	...
	strHtml += '<table border="0" cellspacing="0" cellpadding="0" width="100%">' 
	+ '<tr>'
	+ '<th class="plaintableheaderbordergrey" id="licenses" style="width:63%;" colspan="3">'+getSeaPhrase("LICENSES","CR")+'</th>'
	+ '<th class="plaintableheaderbordergrey" id="AOA" style="width:37%;">'+getSeaPhrase("CR_21","CR")+'</th>'
	+ '</tr>'
	+ '</table>'
	...
	strHtml += '<table border="0" cellspacing="0" cellpadding="0" width="100%">' 
	+ '<tr>'
	+ '<th class="plaintableheaderbordergrey" id="ABMS" style="width:63%;" colspan="3">'+getSeaPhrase("CR_18","CR")+'</th>'
	+ '<th class="plaintableheaderbordergrey" id="DEA" style="width:37%;">'+getSeaPhrase("CR_23","CR")+'</th>'
	+ '</tr>'
	+ '</table>'
	...
	strHtml += '<table border="0" cellspacing="0" cellpadding="0" width="100%">' 
	+ '<tr>'
	+ '<th class="plaintableheaderbordergrey" id="AMA" style="width:63%;" colspan="3">'+getSeaPhrase("CR_24","CR")+'</th>'
	+ '<th class="plaintableheaderbordergrey" id="major" style="width:37%;">'+getSeaPhrase("CR_25","CR")+'</th>'
	+ '</tr>'
	+ '</table>'
	...
	strHtml += '<table border="0" cellspacing="0" cellpadding="0" width="100%">' 
	+ '<tr>'
	+ '<th class="plaintableheaderbordergrey" id="sanctions" style="width:63%;" colspan="3">'+getSeaPhrase("SANCTIONS","CR")+'</th>'
	+ '<th class="plaintableheaderbordergrey" id="self" style="width:37%;">'+getSeaPhrase("CR_26","CR")+'</th>'
	+ '</tr>'
	+ '</table>'
