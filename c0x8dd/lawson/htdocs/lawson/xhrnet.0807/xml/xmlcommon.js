...
// $Header: /cvs/cvs_archive/applications/webtier/shr/src/xhrnet/xml/xmlcommon.js,v 1.14.2.61 2012/06/29 17:24:23 brentd Exp $
//***************************************************************
//*                                                             *
//*                           NOTICE                            *
//*                                                             *
...
function getUserLanguage()
{
	...
	while (userLang == null && userWnd != top)
	{
		try 
		{
			userLang = userWnd.authUser.language;
		}
		catch(e)
		{
			userLang = null;
			userWnd = userWnd.parent;
		}
	}	
	...
	{
	 	try {
	 		userLang = tvltGetUserElmSea("LANGUAGE");
	  	} catch(e) {
		 	userLang = null;
		}	
	}
...
function tvltGetUserElmSea(strElement)
{
	...
	{	
		...
		else if (typeof(page.objUSERENVXML) == "undefined")
		{
			...
			var cntType = "text/xml; charset=UTF-8";
			var outType = "text/xml";
			page.objUSERENVXML = httpRequest("/servlet/Profile?_SECTION=attributes",null,cntType,outType);
		}
