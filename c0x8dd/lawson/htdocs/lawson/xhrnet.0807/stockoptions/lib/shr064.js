...
// $Header: /cvs/cvs_archive/applications/webtier/shr/src/xhrnet/stockoptions/lib/shr064.js,v 1.8.2.16 2012/06/29 17:24:26 brentd Exp $
//***************************************************************
//*                                                             *
//*                           NOTICE                            *
//*                                                             *
...
function PaintStockOptionGrantTable(Tab, IsMgr)
{
	...
	switch (Tab)
	{
		...
		if (Grants.length > 0)
		{
			...
			returnVal += '<th class="plaintableheaderborderright" style="width:80px;" styler_click="StylerEMSS.onClickColumn" styler_init="StylerEMSS.initListColumn">';
		...
		for (var i=0; i<Grants.length; i++)
		{
			...
			returnVal += '<td class="plaintablecellborderright" style="width:80px;">';
		...
		if (Grants.length > 0)
		{
			...
			returnVal += '<th class="plaintableheaderborderright" style="width:100px;" styler_click="StylerEMSS.onClickColumn" styler_init="StylerEMSS.initListColumn">';
			returnVal += '<a class="columnsort" href="" onclick="parent.SortGrants(\'AvailableShares\',true);return false">';
		...
		for (var i=0; i<Grants.length; i++)
		{
			...
			returnVal += '<td class="plaintablecellborderright" style="width:70px;">';
...
function PaintBottomLeftWindow()
{
	...
	if (VestedDetail.length > 0)
	{
		...
		returnVal += '<th class="plaintableheaderborderright" style="width:80px;">'+getSeaPhrase("PERCENT","ESS")+'</th>';
		returnVal += '<th class="plaintableheaderborderright" style="width:80px;">'+getSeaPhrase("CUMULATIVE_SHARES","ESS")+'</th>';
		returnVal += '<th class="plaintableheaderborderright" style="width:80px;">'+getSeaPhrase("PERIOD_PERCENT","ESS")+'</th>';
		returnVal += '<th class="plaintableheaderborderright" style="width:80px;">'+getSeaPhrase("PERIOD_SHARES","ESS")+'</th>';	
	}	
	...
	for (var i=0; i<VestedDetail.length; i++)
	{
		...
		returnVal += '<td class="plaintablecellborderright" style="width:80px;">'+formatComma(VestedDetail[i].PeriodShares,true)+'</td>';
	}
...
function PaintTopRightWindow(index)
{
	...
	returnVal += '<tr><td class="plaintablerowheaderborder" style="width:50%;">'+getSeaPhrase("GRANT_ID","ESS")+'</td>';
	returnVal += '<td class="plaintablecelldisplayright" style="width:50%;">'+Grant.GrantID+'</td></tr>';
	returnVal += '<tr><td class="plaintablerowheaderborder" style="width:50%;">'+getSeaPhrase("STOCK_SYMBOL","ESS")+'</td>';
	returnVal += '<td class="plaintablecelldisplayright" style="width:50%;">'+Grant.StockSymbol+'</td></tr>';
	returnVal += '<tr><td class="plaintablerowheaderborder" style="width:50%;">'+getSeaPhrase("DATE_TO_EXPIRE","ESS")+'</td>';
	returnVal += '<td class="plaintablecelldisplayright" style="width:50%;">'+FormatDte4(Grant.ExpireDate)+'</td></tr>';
	returnVal += '<tr><td class="plaintablerowheaderborder" style="width:50%;">&nbsp;</td>';
	returnVal += '<td class="plaintablecelldisplayright" style="width:50%;">&nbsp;</td></tr>';
	returnVal += '<tr><td class="plaintablerowheaderborder" style="width:50%;">'+getSeaPhrase("SHARES","ESS")+':</td>';
	returnVal += '<td class="plaintablecelldisplayright" style="width:50%;">&nbsp;</td></tr>';
	returnVal += '<tr><td class="plaintablerowheaderborder" style="width:50%;">'+getSeaPhrase("VESTED","ESS")+'</td>';
	returnVal += '<td class="plaintablecelldisplayright" style="width:50%;">'+formatComma(Grant.VestedShares,true)+'</td></tr>';
	returnVal += '<tr><td class="plaintablerowheaderborder" style="width:50%;">'+getSeaPhrase("UNVESTED","ESS")+'</td>';
	returnVal += '<td class="plaintablecelldisplayright" style="width:50%;">'+formatComma(Grant.UnvestedShares,true)+'</td></tr>';
	returnVal += '<tr><td class="plaintablerowheaderborder" style="width:50%;">'+getSeaPhrase("AS_OF_DATE","ESS")+'</td>';
	returnVal += '<td class="plaintablecelldisplayright" style="width:50%;">'+fmttoday+'</td></tr>';
	returnVal += '<tr><td class="plaintablerowheaderborder" style="width:50%;">'+getSeaPhrase("VESTED","ESS")+'</td>';
	returnVal += '<td class="plaintablecelldisplayright" style="width:50%;">'+formatComma(Grant.VestedShares,true)+'</td></tr>';
	returnVal += '<tr><td class="plaintablerowheaderborder" style="width:50%;">'+getSeaPhrase("EXERCISED","ESS")+'</td>';
	returnVal += '<td class="plaintablecelldisplayright" style="width:50%;">'+formatComma(Grant.ExercisedShares,true)+'</td></tr>';
	returnVal += '<tr><td class="plaintablerowheaderborder" style="width:50%;">'+getSeaPhrase("FORFEITED","ESS")+'</td>';
	returnVal += '<td class="plaintablecelldisplayright" style="width:50%;">'+formatComma(Grant.ForfeitedShares,true)+'</td></tr>';	
	returnVal += '<tr><td class="plaintablerowheaderborder" style="width:50%;">'+getSeaPhrase("EXPIRED","ESS")+'</td>';
	...
	returnVal += '<tr><td class="plaintablerowheaderborderbottom" style="width:50%;">'+getSeaPhrase("AVAILABLE","ESS")+'</td>';
	returnVal += '<td class="plaintablecelldisplayright" style="width:50%;">'+formatComma(Grant.AvailableShares,true)+'</td></tr>';
	returnVal += '</table>';
