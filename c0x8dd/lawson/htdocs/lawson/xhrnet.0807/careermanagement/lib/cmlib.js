...
// $Header: /cvs/cvs_archive/applications/webtier/shr/src/xhrnet/careermanagement/lib/Attic/cmlib.js,v 1.1.2.28 2012/07/19 13:31:56 brentd Exp $
//***************************************************************
//*                                                             *
//*                           NOTICE                            *
//*                                                             *
...
{
	var Desc = '<form name="'+Label+'" onSubmit="return false">'
	Desc += '<input class="contenttextCM" style="width:'+(Width-17)+'" type=text name="'+TextName+'" size="'+parseInt(Size,10)+'"'
...
function DrawWindow()
{
	...
	else
	{
		...
		if(this.AddCloseIcon)
		{
			...
			Desc += 'onMouseOver="this.src=\''+XIconOver+'\';return true;" onMouseDown="this.src=\''+XIconActive+'\';return true;" '
...
function DrawTabbedWindow(TabDesc)
{
	...
	else
	{
		var Desc = '<div class="panewrapperCM">'
			...
			+'<div class="paneinnerborderCM" styler="groupbox"></div>'
			+'</td></tr></table>'
			+'</div>'
			+'</td></tr></table>'
			+'</div>'
...
function buttonLayer(framename, name, left, top, width, height, visible, content, bgtype, background, MSScroll, IFrame, zIndex)
{
	...
	layerList[z] = name;
  	...
  	if (docLoc.all || docLoc.getElementById) {
		...
		LayHtml += ' top:' + top + 'px; width:' + width + 'px; height:' + height + 'px;' + ' visibility:' + (visible ? 'visible;' : 'hidden;') + ' z-index:' + z
...
function BuildTitleHTML(framename,name,Minimized,ResizeFlag,closeFlag,width,title,framewidth)
{
	var Desc;
	if (width>100)
		Desc = "<table width=" + (width+(framewidth*2)) + "><tr><td>" + title + "</td><td class='textAlignRight'>"
	else
		Desc = "<table width=" + (width+(framewidth*2)) + "><tr><td class='textAlignRight'>"
...
function DrawTabs(Color) // this one has 1px change
{
	...
	Tabs += '<td class="tabbackgroundborderbottomCM" style="width:100%">&nbsp;</td></tr>'
	Tabs += '</table></div>'
...
function AddQualificationButton_MyQualifications_OnClick()
{
	...
	var buttonStr = '<tr><td>&nbsp;</td><td width="10">&nbsp;</td><td style="white-space:nowrap;padding-top:10px">'
	...
	switch(_TABSELECTED)
	{
		case 0:
			...
			if (emssObjInstance.emssObj.filterSelect)
			{
				...
				+ '<span id="competencyDesc" style="width:150px" class="fieldlabelleft"></span>'
				+ '</td></tr>'
			}
			else
			{				
			...
			if (emssObjInstance.emssObj.filterSelect)
			{
				...
				+ '<img align="top" src="/lawson/xhrnet/ui/images/ico_form_dropmenu.gif" border="0"></a>'
				+ '<span id="skillsourceDesc" style="width:150px" class="fieldlabelleft"></span>'
				+ '</td></tr>'
			}
			else
			{			
		...
		case 1:
			...
			if (emssObjInstance.emssObj.filterSelect)
			{
				...
				+ '<img align="top" src="/lawson/xhrnet/ui/images/ico_form_dropmenu.gif" border="0"></a>'
				+ '<span id="certificationDesc" style="width:150px" class="fieldlabelleft"></span>'
				+ '</td></tr>'
			}
			else
			{			
			...
			if (emssObjInstance.emssObj.filterSelect)
			{
				...
				+ '<img align="top" src="/lawson/xhrnet/ui/images/ico_form_dropmenu.gif" border="0"></a>'
				+ '<span id="currencycodeDesc" style="width:150px" class="fieldlabelleft"></span>'
				+ '</td></tr>'
			}
			else
			{			
		...
		case 2:
			...
			if (emssObjInstance.emssObj.filterSelect)
			{
				...
				+ '<img align="top" src="/lawson/xhrnet/ui/images/ico_form_dropmenu.gif" border="0"></a>'
				+ '<span id="degreeDesc" style="width:150px" class="fieldlabelleft"></span>'
				+ '</td></tr>'
			}
			else
			{			
			...
			if (emssObjInstance.emssObj.filterSelect)
			{
				...
				+ '<img align="top" src="/lawson/xhrnet/ui/images/ico_form_dropmenu.gif" border="0"></a>'
				+ '<span id="instructorDesc" style="width:150px" class="fieldlabelleft"></span>'
				+ '</td></tr>'
			}
			else
			{			
...
function DrawCategoryInstructions_MyQualifications()
{
	...
	createLayer("main","Category_Instructions",10,75,380,40,true,Desc,"","");

	Desc = '<span class="contenttextCM">'+getSeaPhrase("CM_258","CM")+'</span>'
	createLayer("main","Category_InstructionsAdd",10,75,380,40,false,Desc,"","");
	...
	else
	{
		...
		else
		{
			...
			if (emssObjInstance.emssObj.filterSelect)
			{
				...
				+ '<a href="javascript:parent.openDmeFieldFilter(\'skillsource\')" style="margin-left:5px">'
				+ '<img align="top" src="/lawson/xhrnet/ui/images/ico_form_dropmenu.gif" border="0"></a>'
				+ '<span id="skillsourceDesc" style="width:150px" class="fieldlabelleft">'+pDme.skill_source_description+'</span>'
				+ '</td></tr>'
			}
			else
			{			
			...
			Desc += '<tr><td>&nbsp;</td><td width=10>&nbsp;</td><td style="white-space:nowrap;padding-top:10px">'
			if(MyQualifications || EmployeeQualifications) {
	...
	else
	{
		...
		else
		{
			...
			if (emssObjInstance.emssObj.filterSelect)
			{
				...
				+ '<a href="javascript:parent.openDmeFieldFilter(\'currencycode\')" style="margin-left:5px">'
				+ '<img align="top" src="/lawson/xhrnet/ui/images/ico_form_dropmenu.gif" border="0"></a>'
				+ '<span id="currencycodeDesc" style="width:150px" class="fieldlabelleft">'+pDme.currency_description+'</span>'
				+ '</td></tr>'
			}
			else
			{			
	...
	else
	{
		...
		else
		{
			...
			if (emssObjInstance.emssObj.filterSelect)
			{
				...
				+ '<a href="javascript:parent.openDmeFieldFilter(\'subject\')" style="margin-left:5px">'
				+ '<img align="top" src="/lawson/xhrnet/ui/images/ico_form_dropmenu.gif" border="0"></a>'
				+ '<span id="subjectDesc" style="width:150px" class="fieldlabelleft">'+pDme.subject_description+'</span>'
				+ '</td></tr>'
			}
			else
			{			
			...
			if (emssObjInstance.emssObj.filterSelect)
			{
				...
				+ '<a href="javascript:parent.openDmeFieldFilter(\'instructor\')" style="margin-left:5px">'
				+ '<img align="top" src="/lawson/xhrnet/ui/images/ico_form_dropmenu.gif" border="0"></a>'
				+ '<span id="instructorDesc" style="width:150px" class="fieldlabelleft">'+pDme.institution_description+'</span>'
				+ '</td></tr>'
			}
			else
			{						
