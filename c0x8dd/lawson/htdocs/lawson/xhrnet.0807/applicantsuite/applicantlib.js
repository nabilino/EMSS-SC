...
// $Header: /cvs/cvs_archive/applications/webtier/shr/src/xhrnet/applicantsuite/Attic/applicantlib.js,v 1.1.2.15 2012/06/29 17:24:27 brentd Exp $
//***************************************************************
//*                                                             *
//*                           NOTICE                            *
//*                                                             *
...
function CensusForm()
{
	...
	html += uiButton(getSeaPhrase("BACK","ESS"),"parent.ProcessFormcd();parent.DspPrvEmploym();return false", "margin-left:5px")
...
{       
	...
	html += uiButton(getSeaPhrase("BACK","ESS"), "parent.GetDataj();parent.GetCountryCodes();return false", "margin-left:5px")
	html += uiButton(getSeaPhrase("QUIT","ESS"), "parent.CheckQuit();return false", "margin-left:5px")
	html += '</td>'
	html += '</tr>'
   	html += '</table>'
...
function DspGenInt()
{
	...
	html += uiButton(getSeaPhrase("BACK","ESS"),"parent.GetDatagi();parent.GetJobOpen();return false", "margin-left:5px")
	html += uiButton(getSeaPhrase("QUIT","ESS"),"parent.CheckQuit();return false", "margin-left:5px")
	html += '</td>'
	html += '</tr>'
	html += '</table>'
...
function DspPrvEmploym()
{
	...
	html += uiButton(getSeaPhrase("BACK","ESS"),"parent.GetDatape();parent.DspGenInt();return false", "margin-left:5px")
	html += uiButton(getSeaPhrase("QUIT","ESS"),"parent.CheckQuit();return false", "margin-left:5px")
	html += '</td>'
	html += '</tr>'
	html += '</table>'
...
function StartAppKnow()
{
	...
	html += '</p>'
	html += '<table border="0" cellspacing="0" cellpadding="0" styler="list">'
