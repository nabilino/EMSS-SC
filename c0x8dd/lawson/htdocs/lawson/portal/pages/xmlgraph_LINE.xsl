<?xml version="1.0"?>
<!-- $Header: /cvs/cvs_archive/LawsonPlatform/ui/portal/pages/xmlgraph_LINE.xsl,v 1.3.36.2 2012/08/08 12:37:25 jomeli Exp $ -->
<!-- $NoKeywords: $ -->
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:v="urn:schemas-microsoft-com:vml" version="1.0">
	<xsl:template match="/">
		...
		<table id="graphcontainer" graphtype="LINE" border="0" cellpadding="0" cellspacing="0" style="width:100%; height:100%;" class="graphcontainer">
			<tr>
				<td>&#160;</td>
