<?xml version="1.0"?>
<!-- $Header: /cvs/cvs_archive/LawsonPlatform/ui/portal/pages/xmlgraph_HBAR.xsl,v 1.3.36.2 2012/08/08 12:37:25 jomeli Exp $ -->
<!-- $NoKeywords: $ -->
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:v="urn:schemas-microsoft-com:vml" version="1.0">
	<xsl:template match="/">
		<!--// begin graph // -->
		<table id="graphcontainer" graphtype="HBAR" border="0" cellpadding="0" cellspacing="0" style="width:100%; height:100%;" class="graphcontainer">
			<tr>
				<td>&#160;</td>
				<td id="graphtitle" class="graphtitle" style="height:0; vertical-align:top; padding-bottom:5px;"><xsl:value-of select="//title"/></td>
			</tr>
			<!--expression( this.clientHeight )-->

			<tr>
				<td style="width:expression( yaxis.clientWidth ); vertical-align:top">
					<!-- // begin y axis // -->
					<div id="ypos" style="position:relative; height:0; background-color:#FFFF00">&#160;</div><!--width:expression( ylbl0.style.width );-->
					<table id="yaxis" border="0" cellpadding="0" cellspacing="0" style="height:100%">
						<tr>
							<td class="graphcategory" style="writing-mode:tb-rl">
								<xsl:value-of select="//value"/>
							</td>
							<td id="ylabelcontainer" style="vertical-align:top">ylabels</td>
				...
				<td id="graphbodycontainer">
					<!-- // begin graphbody // -->
					<div id="graphbody" class="graphbody" style="width:100%; height:100%" onmouseover="window.status='resizeCount='+( getResizeCount() )">graphbody</div>
					<!-- // end graphbody // -->
				</td>
			</tr>
			<tr style="height:expression( xaxis.clientHeight )">
				...
				<td style="vertical-align:top">
					...
					<table id="xaxis" border="0" cellpadding="0" cellspacing="0" style="width:100%">
						...
						<tr>
							<td class="graphcategory" style="height:expression( this.clientHeight ); vertical-align:top;">
