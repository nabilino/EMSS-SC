/* $Header: /cvs/cvs_archive/LawsonPlatform/ui/portal/dialogs/fontpick.js,v 1.2.2.1.18.1.2.2 2012/08/08 12:37:24 jomeli Exp $ */
/* $NoKeywords: $ */
...
function fontInit()
{
	...
	// validate required portal components
	if (typeof(portalWnd.trim) != "function"
	|| typeof(portalWnd.cmnDlg) != "object")
	{
		alert("Required portal components are missing.")
		window.close();
		return;
	}
	...
	for (var j = 0; j < len; j++)
	{
		...
		case "family":
			...
			{
				font=portalWnd.trim(arrFonts[f])
...
function updateFont()
{
	...
	{
		Font.focus()
		portalWnd.cmnDlg.messageBox("Please select at least one font family.")
		return;
	}
