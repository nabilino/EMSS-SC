...
Slrmc.prototype.EPOReminder=function(ruletype) {
  ...
  if(ruletype=="N") {
		...
		wording += '<P><B>Important:  </B> Enroll in St. Luke\'s Healthy U for an opportunity to earn health plan premium reductions for both you and your covered spouse by completing two annual requirements within 30 days of your hire date and/or by the published open enrollment deadline.</P>';
		wording += '<P><b>Complete First: Know Your Numbers (KYN) Screening</b><br>The KYN Screening consists of biometric measures such as blood pressure, height, weight, body mass index (BMI), waist circumference, nicotine screening and fasting blood glucose. Employees with diabetes will need to provide an A1c lab result.</p>';
//           wording += '<UL>';
...
// END OF MOD 
	...
	// CGL 1/13/2011 - Per Dru Sewchok child life age rules are now aligned between companies; update ages in non-co 1 text
     ...
     wording += '<P>Children are eligible for coverage up to age 19 or up to age 23 if a full-time student.  Rates are based on the coverage amount and are not on a per child basis.  For example, if you have 3 children and elect $10,000 of child supplemental life for all of them, the premium is $0.25 per pay period.</P>';
...
//			}
				...
				wording += '<p>Your medical FSA account has a per pay period maximum of $96.16 up to an annual maximum of $2500.</p>';
