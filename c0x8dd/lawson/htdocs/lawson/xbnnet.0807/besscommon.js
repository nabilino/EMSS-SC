...
// $Header: /cvs/cvs_archive/applications/webtier/shr/src/xbnnet/besscommon.js,v 1.32.2.60 2012/08/03 08:15:24 kevinct Exp $
//***************************************************************
//*                                                             *
//*                           NOTICE                            *
//*                                                             *
...
function writeDepPortion(dte)
{
	...
	deps+='<table class="plaintableborder" border="0" cellpadding="0" cellspacing="0" styler="list" style="width:100%;margin-left:auto;margin-right:auto">'
	deps+='<tr>'
	...
	for(var i=0; i<dependents.length; i++) {
		for(var x=0; x<coveredDeps.length; x++) {
			if(dependents[i].seq_nbr==coveredDeps[x].dependent) {
				...
				deps+='<td class="plaintablecellborder" style="white-space:nowrap">'
	...
	if ((NbrCoveredDeps % 2) != 0) {
		deps+='<td class="plaintablecellborder" style="white-space:nowrap">&nbsp;</td></tr>'
	}
	deps+='</table>'
	if(NbrCoveredDeps>0)
		return '<br>'+deps
...
{		
	...
	if(REC_TYPE=="01" || parseFloat(REC_TYPE)==1)
	{
		...
		if(CHANGED)
			bod+="* "
		bod+=PLAN_TYPE+'&nbsp;</td><td class="plaintablecellborderright" nowrap>&nbsp;'+arr[2]+'&nbsp;</td>'
		if(showDate)
	...
	if(REC_TYPE=="03" || parseFloat(REC_TYPE)==3 || REC_TYPE=="13" || parseFloat(REC_TYPE)==13)
	{
		...
		if(CHANGED)
			bod+="* "
		bod+=PLAN_TYPE+'&nbsp;</td><td class="plaintablecellborderright" nowrap>&nbsp;'
		if(arr[11] && arr[11]!="")
	...
	if(REC_TYPE=="04" || parseFloat(REC_TYPE)==4)
	{
		...
		if(CHANGED)
			bod+="* "
		bod+=PLAN_TYPE+'&nbsp;</td><td class="plaintablecellborderright" nowrap>&nbsp;'+formatCont(arr[17])+'&nbsp;</td>'
		if(showDate)
			bod+='<td class="plaintablecellborder">&nbsp;'+planDate+'&nbsp;</td>'
		if (!issplit)
			bod+=getCosts(arr,REC_TYPE,PLAN_TYPE,isflex,issplit,"P",false)+'</tr>'
	...
	if(REC_TYPE=="07" || parseFloat(REC_TYPE)==7)
	{
		...
		if(CHANGED)
			bod+="* "
		bod+=PLAN_TYPE+'&nbsp;</td><td class="plaintablecellborderright" nowrap>&nbsp;'+arr[23]+' '+getSeaPhrase("HOURS","BEN")+'&nbsp;</td>'
		if(showDate)
			bod+='<td class="plaintablecellborder">&nbsp;'+planDate+'&nbsp;</td>'
		if (!issplit)
			bod+=getCosts(arr,REC_TYPE,PLAN_TYPE,isflex,issplit,"P",false)+'</tr>'
...
function GetSummaryTable()
{
	...
	var table = '<table class="plaintableborder" border="0" cellspacing="0" cellpadding="0" style="width:100%;margin-left:auto;margin-right:auto" styler="list">'
	table += '<tr>'
	table += '<th class="plaintableheaderborder" style="width:50%;text-align:center;white-space:nowrap">'+cost_div_desc+'</th>'
	table += '<th class="plaintableheaderborder" style="width:50%;text-align:center;white-space:nowrap">'+getSeaPhrase("COST","BEN")+'</th>'
	table += '</tr>'
	...
	if (EmpFlexTotal != 0) {
		table += '<tr>'
		table += '<td class="plaintablecellborderright">'+getSeaPhrase("CURBEN_4","BEN")+'</td>'
		table += '<td class="plaintablecellborderright">'+(formatCont(EmpFlexTotal)?formatCont(EmpFlexTotal):'&nbsp;')+'</td>'
		table += '</tr>'
	}
	if (BenCreditTotal != 0) {
		table += '<tr>'
		table += '<td class="plaintablecellborderright">'+getSeaPhrase("CURBEN_5","BEN")+'</td>'
		table += '<td class="plaintablecellborderright">'+(formatCont(BenCreditTotal)?formatCont(BenCreditTotal):'&nbsp;')+'</td>'
		table += '</tr>'
	}
	if (FlexCreditTotal != 0 && EmpFlexTotal != 0 && BenCreditTotal != 0) {
		table += '<tr>'
		table += '<td class="plaintablecellborderright">'+getSeaPhrase("CURBEN_6","BEN")+'</td>'
		table += '<td class="plaintablecellborderright">'+(formatCont(FlexCreditTotal)?formatCont(FlexCreditTotal):'&nbsp;')+'</td>'
		table += '</tr>'
	}
	if (FlexCreditTotal != 0) {
		table += '<tr>'
		table += '<td class="plaintablecellborderright">*** '+getSeaPhrase("CURBEN_7","BEN")+'</td>'
		table += '<td class="plaintablecellborderright">&nbsp;</td>'
		table += '</tr>'
	}
	if (EmpPreTaxTotal != 0 && FlexCreditTotal != 0) {
		table += '<tr>'
		table += '<td class="plaintablecellborderright">'+getSeaPhrase("CURBEN_8","BEN")+'</td>'
		table += '<td class="plaintablecellborderright">'+(formatCont(EmpPreTaxTotal)?formatCont(EmpPreTaxTotal):'&nbsp;')+'</td>'
		table += '</tr>'
	}
	if (CreditsLessPreTax < 0)
	{
		table += '<tr>'
		table += '<td class="plaintablecellborderright">'+getSeaPhrase("CURBEN_9","BEN")+'</td>'
	...
	if (CreditsLessPreTax == 0 && EmpPreTaxFlexTotal != 0) {
		table += '<tr>'
		table += '<td class="plaintablecellborderright">'+getSeaPhrase("CURBEN_10","BEN")+'</td>'
		table += '<td class="plaintablecellborderright">&nbsp;</td>'
		table += '</tr>'
	}
	if (CreditsLessPreTax > 0) {
		table += '<tr>'
		table += '<td class="plaintablecellborderright">'+getSeaPhrase("CURBEN_11","BEN")+'</td>'
		table += '<td class="plaintablecellborderright">'+(formatCont(CreditsLessPreTax)?formatCont(CreditsLessPreTax):'&nbsp;')+'</td>'
		table += '</tr>'
	}
	if (CreditsLessPreTax > 0 && AddToGrossPercent == 0) {
		table += '<tr>'
		table += '<td class="plaintablecellborderright">'+getSeaPhrase("CURBEN_12","BEN")+'</td>'
		table += '<td class="plaintablecellborderright">&nbsp;</td>'
		table += '</tr>'
	}
	...
	if (AddedToPay != 0) {
		table += '<tr>'
		table += '<td class="plaintablecellborderright">'+getSeaPhrase("CURBEN_16","BEN")+'</td>'
		table += '<td class="plaintablecellborderright">'+(formatCont(AddedToPay)?formatCont(AddedToPay):'&nbsp;')+'</td>'
		table += '</tr>'
	}
	table += '<tr>'
	table += '<td class="plaintablecellborderright">'+getSeaPhrase("CURBEN_17","BEN")+'</td>'
	table += '<td class="plaintablecellborderright">'
	...
	if (EmpPreTaxPercentTotal > 0) {
		table += '<tr>'
		table += '<td class="plaintablecellborderright">'+getSeaPhrase("CURBEN_18","BEN")+'</td>'
		table += '<td class="plaintablecellborderright">'+(formatCont(EmpPreTaxPercentTotal)?formatCont(EmpPreTaxPercentTotal):'&nbsp;')+'</td>'
		table += '</tr>'
	}
	if (EmpAfterTaxPercentTotal > 0) {
		table += '<tr>'
		table += '<td class="plaintablecellborderright">'+getSeaPhrase("CURBEN_19","BEN")+'</td>'
		table += '<td class="plaintablecellborderright">'+(formatCont(EmpAfterTaxPercentTotal)?formatCont(EmpAfterTaxPercentTotal):'&nbsp;')+'</td>'
		table += '</tr>'
	}
	if (EmpPreTaxPercentTotal > 0 && EmpAfterTaxPercentTotal > 0) {
		table += '<tr>'
		table += '<td class="plaintablecellborderright">'+getSeaPhrase("CURBEN_20","BEN")+'</td>'
		table += '<td class="plaintablecellborderright">'+(formatCont(TaxPercentTotal)?formatCont(TaxPercentTotal):'&nbsp;')+'</td>'
		table += '</tr>'
	}
	if (CompanyTotal != 0) {
		table += '<tr>'
		table += '<td class="plaintablecellborderright">'+getSeaPhrase("CURBEN_21","BEN")+'</td>'
		table += '<td class="plaintablecellborderright">'+(formatCont(CompanyTotal)?formatCont(CompanyTotal):'&nbsp;')+'</td>'
		table += '</tr>'
	}
	table += '</table>'
	table += '<table border="0" cellspacing="0" cellpadding="0" style="width:100%;margin-left:auto;margin-right:auto">'
	table += '<tr>'
	table += '<td colspan="2" class="plaintablecellsmallright" style="padding-top:3px;font-size:8pt">'+getSeaPhrase("ROUNDING_NOTE","BEN")+'</td>'
	table += '</tr>'
	table += '</table>'
	return table
}
...
function GetShowElectionsHeader(justText)
{
	...
	hdr +='<p><table class="plaintableborder" border="0" style="width:100%;margin-left:auto;margin-right:auto" cellpadding="0" cellspacing="0">'
	    + '<tr><th class="plaintablerowheaderborder" nowrap>'+getSeaPhrase("EMPNAME","BEN")
	    + '</th><td class="plaintablecellborderdisplayright" nowrap>'+fullname
 	    + '</td><th class="plaintablerowheaderborder" nowrap>'+getSeaPhrase("SSN","BEN")
	    + '</th><td class="plaintablecellborderdisplayright" nowrap>'+("XXX-XX-" + ficanbr.substring(ficanbr.length-4,ficanbr.length))
	    + '</td></tr><tr><th class="plaintablerowheaderborder" nowrap>'+getSeaPhrase("EMPNUM","BEN")
	    + '</th><td class="plaintablecellborderdisplayright" nowrap>'+employee
	    + '</td><th class="plaintablerowheaderborder" nowrap>'+getSeaPhrase("DOB","BEN")
	    + '</th><td class="plaintablecellborderdisplayright" nowrap>'+dateofbirth
	    + '</td></tr>'
	if (emssObjInstance.emssObj.benPayInfo)
	{
		...
		hdr +='</th><td class="plaintablecellborderdisplayright" nowrap>'+formatCont(empsalary)		
...
function printScr(frm,justText,onFinal)
{
	...
	{
		head += '<div class="plaintablecellbold">' + getSeaPhrase("CONBEN_17","BEN") + "<br>"
	...
	if (depsExist) 
	{
		bod2 += '<br>';
		bod2 += '<center>';
		bod2 += '<table class="plaintableborder" border="0" cellpadding="0" cellspacing="0" styler="list" style="width:100%;margin-left:auto;margin-right:auto">';
		bod2 += '<tr>';
	...
	head += '<center>'
	+ '<table class="plaintableborder" border="0" cellspacing="0" cellpadding="0" style="width:100%;margin-left:auto;margin-right:auto" styler="list">'
	+ '<tr>'
	...
	if (compflag == 1)
		head += '<th class="plaintableheaderborderright" nowrap scope="col">' + getSeaPhrase("CO_COST","BEN") + "</th>";
	else
...
function emailScr(wnd, error)
{
	...
	if (typeof(wnd["ProcessFlowObject"]) == "function")
	{
