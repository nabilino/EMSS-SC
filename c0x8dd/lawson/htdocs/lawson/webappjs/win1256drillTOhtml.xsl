<?xml version="1.0"?>
<!-- $Header: /cvs/cvs_archive/applications/webtier/webappjs/Attic/win1256drillTOhtml.xsl,v 1.1.4.4.2.6 2014/02/18 16:42:32 brentd Exp $ -->
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xt="http://www.jclark.com/xt" version="1.0" extension-element-prefixes="xt">
	<xsl:output method="html" encoding="windows-1256" indent="no"/>
				...
				<tbody>
					<tr>
						<td style="text-align:center;padding-bottom:2px">
							<a id="backLnk" href="javascript:history.back(1);" styler="hyperlink">Back</a>
						</td>
					</tr>
				</tbody>
				</table>
