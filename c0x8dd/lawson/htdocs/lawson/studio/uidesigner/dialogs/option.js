/* $Header: /cvs/cvs_archive/LawsonPlatform/toolkit/studio/uidesigner/dialogs/option.js,v 1.4.6.1.16.2 2012/08/08 12:48:49 jomeli Exp $ */
/* $NoKeywords: $ */
...
function optInit()
{
	...
	else
	{
		...
		txtDataValue.value=optNode.getAttribute("Tran")?optNode.getAttribute("Tran"):optNode.getAttribute("Disp")
		txtDisplayValue.value=optNode.getAttribute("Disp")
		txtPhrase.value=optNode.text
	}
...
function optOnOK()
{
	...
	optNode.setAttribute("Disp", txtDisplayValue.value)
	if (optNode.childNodes.length)
		optNode.replaceChild(oFormDef.createTextNode(txtPhrase.value), optNode.childNodes[0])
	else
		optNode.appendChild(oFormDef.createTextNode(txtPhrase.value))
