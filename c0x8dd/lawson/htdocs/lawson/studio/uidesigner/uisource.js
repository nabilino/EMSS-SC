/* $Header: /cvs/cvs_archive/LawsonPlatform/toolkit/studio/uidesigner/uisource.js,v 1.1.34.2 2012/08/08 12:48:51 jomeli Exp $ */
/* $NoKeywords: $ */
...
{
	this.xmlSrc=myDoc.xmlDoc.xml.replace( /\>\</g, ">\n<" )

	//load xml definition into DOM
	this.xmlDoc=myDesigner.source.uiCreateDOMFromString(this.xmlSrc)
	if (this.xmlDoc)
	{
...
SourceView.prototype.reset=function()
{
	...
	var textBody=this.editor.cwDoc.getElementById("textBody")
	textBody.focus()
	var textloc = textBody.createTextRange();
	textloc.collapse()
	textloc.select()
