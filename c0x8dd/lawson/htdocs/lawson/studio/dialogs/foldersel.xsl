<?xml version="1.0"?>
<!-- $Header: /cvs/cvs_archive/LawsonPlatform/toolkit/studio/dialogs/foldersel.xsl,v 1.1.34.2 2012/08/08 12:48:47 jomeli Exp $ -->
<!-- $NoKeywords: $ -->
		...
		<xsl:sort select="text()" />
			<div class="dsListText" onclick="dlgOnFileClick(this)" type="folder">
				...
				<span style="top:0;left:0;width:10%;text-align:center;">
					<img border="0">
						<xsl:attribute name="src">../images/folderclosed.gif</xsl:attribute>
					</img>
				</span>
