...
// $Header: /cvs/cvs_archive/applications/webtier/shr/src/xhrnet/depinfo.js,v 1.3.2.11 2014/02/17 21:29:54 brentd Exp $
//***************************************************************
//*                                                             *
//*                           NOTICE                            *
//*                                                             *
...
function GetDepInfo(prodline, company, employee, fields, functocall, cond, framename)
{
	...
	{
		var args = arguments;
       	setTimeout(function(){GetDepInfo.apply(this, args);}, 10);
       	return;
	}
	...
	if (!fields || typeof(fields) == "undefined" || fields == null || fields == "")
	{
		...
		+ "pa-employee.hm-phone-cntry;country.country-desc;active-flag;benefits.plan-type;"
		+ "primary-care;primary-care.description"
