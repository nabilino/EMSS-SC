...
// $Header: /cvs/cvs_archive/applications/webtier/shr/src/xhrnet/JobRequisitions/Lib/PA42.js,v 1.6.2.13 2014/02/20 20:04:49 brentd Exp $
//***************************************************************
//*                                                             *
//*                           NOTICE                            *
//*                                                             *
...
function PA42Object()
{
    ...
    this.GrantDesc          = '';
    //ianm 2015/02/24 add new field
    this.ReplacementReason
    //ianm 2015 02 18-- added new fields
    this.ShortDesc1 = '' // short description
    this.ShortDesc2 = ''
    this.ShortDesc3 = ''
    this.SpecReq1 = ''
    this.SpecReq2 = ''
	...
	this.Add = function(CallBack, XMIT)
	{
		...
		pAGSObj.field += "&PJR-DATE-NEEDED=" + formjsDate(formatDME(this.DateNeeded))
		+ "&PJR-CLOSED-DATE=" + formjsDate(formatDME(this.ClosedDate))
		...
		+ "&PJR-TEMP-BEGIN=" + formjsDate(formatDME(this.TemporaryDatesBegin))
		+ "&PJR-TEMP-END=" + formjsDate(formatDME(this.TemporaryDatesEnd))
		...
		+ "&PJR-INTERNAL-START=" + formjsDate(formatDME(this.InternalPostDateStart))
		+ "&PJR-INTERNAL-STOP=" + formjsDate(formatDME(this.InternalPostDateStop))
		+ "&PJR-EXTERNAL-START=" + formjsDate(formatDME(this.ExternalPostDateStart))
		+ "&PJR-EXTERNAL-STOP=" + formjsDate(formatDME(this.ExternalPostDateStop))
		/* ianm -- 2015 02 18 add the short description fields to handle the "Comments" */
		+ "&PJR-SHORT-DESC1=" + ParseAGSValue(this.ShortDesc1)
		+ "&PJR-SHORT-DESC2=" + ParseAGSValue(this.ShortDesc2)
		+ "&PJR-SHORT-DESC3=" + ParseAGSValue(this.ShortDesc3)
		+ "&PJR-SPEC-REQ2=" + ParseAGSValue(this.SpecReq2)
		//alert(this.SpecReq2)
		//alert(ParseAGSValue(this.ShortDesc2))
		//alert(pAGSObj.field)
		...
		+ "&PJR-JOB-CODE=" + ParseAGSValue(this.JobCode.Code);
		if (XMIT)
	...
	{
		var recruitFl = 0;
		recruitFl = (self.jsreturn.record.length > 0) ? self.jsreturn.record[0].recruit_flag : 0;
		if (parseInt(recruitFl,10) == 2)
		{
			var pDMEObj	= new DMEObject(authUser.prodline, "PRSYSTEM");
			pDMEObj.out = "JAVASCRIPT";
			pDMEObj.index = "PRSSET1";
		...
		else if (parseInt(recruitFl,10) == 1)
		{
	...
	this.NeedsOpenDate3 = function(XMIT, checkRecruitFlag)
	{
		if (checkRecruitFlag && self.jsreturn.record.length > 0)
