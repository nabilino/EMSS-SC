...
// $Header: /cvs/cvs_archive/applications/webtier/shr/src/xhrnet/JobRequisitions/NewJobRequisitions/SHR031_CMN.js,v 1.6.2.10 2014/02/20 20:04:49 brentd Exp $
//***************************************************************
//*                                                             *
//*                           NOTICE                            *
//*                                                             *
...
function IsValidNumber(formObj)
{
	...
	{
		setRequiredField(formObj, getSeaPhrase("ENTER_VALID_NUMBER","ESS"));
		return false;
	}
	return true;
}
