...
function startProgram()
{
	...
	html += '<p><font size="2" face="Arial">If you have dependents, please review the information we have on file for accuracy. However, adding or changing dependents on this screen does not affect your elected benefit plans.</font>'
	html += '</p>'
	...
	html += '<font size="2" face="Arial">If you choose to enroll a dependent on your medical, dental and/or vision plan, you will be required to provide documentation to verify the eligibility of any newly-enrolled dependents. <u>This applies if you enroll a dependent(s) whose eligibility has <b>not</b> previously been verified.</u>  You will receive a letter from ConSova (a benefits firm specializing in eligibility verification) requesting copies of documents to verify that the dependents you have enrolled meet our eligibility requirements. Failure to submit the required information will result in termination of coverage for the dependent.</font>'
