...
// $Header: /cvs/cvs_archive/applications/webtier/shr/src/xhrnet/careermanagement/lib/writeattach.js,v 1.5.4.12 2013/10/08 14:25:52 brentd Exp $
//***************************************************************
//*                                                             *
//*                           NOTICE                            *
//*                                                             *
	    ...
	    {	    
			...
			try 
			{
				...
				if (typeof(SSORequest) != "undefined")
					attachData = SSORequest(url, null, cntType, "text/xml", object.showerrors);
				else
					attachData = SEARequest(url, null, cntType, "text/xml", object.showerrors);
...
function callWRITEATTACHForPost(object, string, frameStr, debugFl)
{
	...
	var attachData;
	if (typeof(SSORequest) != "undefined")
		attachData = SSORequest(object.progName, buildAttachXml(string, object.encoding), "text/xml", outType, object.showerrors);
	else
		attachData = SEARequest(object.progName, buildAttachXml(string, object.encoding), "text/xml", outType, object.showerrors);
...
function parseAttachDataXML(frameStr, object, xmlData)
{
	...
	for (var i=0; i<len; i++)
	{
		...
		if (typeof(formjsDate) == "function")
		{
			crtDate = (crtDate != "") ? formjsDate(formatDME(crtDate)) : crtDate;	
			crtTime = (crtTime != "") ? crtTime.replace(/\:/g, "") : crtTime;
			modDate = (modDate != "") ? formjsDate(formatDME(modDate)) : modDate;
	...
	if (object.func)
	{
		...
		if (attNode.length > 0)
		{	
			errMsg = getAttachElementText(attNode[0]);
			errMsgNbr = attNode[0].getAttribute("ErrNbr");
		}
		var fn = attachobj.parent[object.func];
		fn.apply(this, new Array("", errMsgNbr, errMsg, ""));
	}	
}
